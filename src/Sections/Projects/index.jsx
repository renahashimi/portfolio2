...
/**
 * Projects Component.
 * Displays a list of projects with their images, titles, descriptions, and links.
 * Includes modals to show full project details and a full-size image viewer.
 * 
 * @component
 * @example
 * return (
 ...
 * )
 * 
 * @returns {JSX.Element} The rendered Projects component with interactive modals.
 */
function Projects() {
  /**
   * The currently selected project to display in the modal.
   * @type {Object|null}
   */
  const [selectedProject, setSelectedProject] = useState(null);

  /**
   * The state for showing a full-size image of the selected project.
   * @type {string|null}
   */
    ...
    <section id="projects" className="m-h-screen flex flex-col items-center justify-center text-white pt-[100px]">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 px-6 pt-[60px]">
        {projects.map((project) => (
          <div
            key={project.id}
            className="bg-white font-lora shadow-lg p-2 text-center border-2 border-custom-dark transition-all duration-300 relative shadow-[0_0_3px_#998787,0_0_12px_#998787,0_0_10px_black] hover:shadow-[0_0_10px_#6E5D5D,0_0_10px_#000,0_0_30px_#6E5D5D] opacity-85 hover:opacity-100"
          >
            <div className="max-w-[450px] md:max-w-full block md:flex md:flex-row lg:block items-center lg:items-start">
              <img
                src={project.image}
                alt={project.title}
                className="md:w-1/2 lg:w-full h-full max-h-[330px] lg:h-[230px] object-cover mb-4 lg:mb-0 md:w-1/2 lg:mr-4 border-2 border-custom-dark cursor-pointer shadow-lg shadow-black"
              ...
              <div className="md:w-1/2 flex flex-col md:ms-6 lg:ms-0 lg:block lg:w-full items-center lg:items-start">
                ...
                <div className="flex justify-center my-2 space-x-4">
                  <a
                    ...
                    className="flex items-center border-2 border-black max-w-1/2 text-black px-2 py-1 rounded-lg hover:bg-custom-dark hover:text-white transition"
                  >
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center bg-gray-900 text-white border-2 border-black px-2 py-1 rounded-lg hover:bg-custom-dark transition"
                  >
          ...
          >
            ...
            <div className="flex flex-col lg:flex-row">
              ...
              <div className="lg:w-1/2">
                ...
                <p className="text-base md:text-xl text-black lg:text-xl mb-4">{selectedProject.description}</p>
                ...
                <div className="block sm:flex gap-2 mt-4 mb-4 font-semibold">
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center border-2 border-black max-w-1/2 text-black px-2 py-1 rounded-lg mb-3 sm:mb-0 hover:bg-custom-dark hover:text-white transition"
                  >
                    <FaExternalLinkAlt className="mr-2" /> Live Demo
                  </a>
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center border-2 border-black bg-gray-900 text-white px-4 py-2 rounded-lg hover:bg-custom-dark hover:border-black transition"
                  >
                    <FaGithub className="mr-2" /> GitHub
                  </a>
                </div>
