...
const projects = [
  ...
  {
    id: 2,
    title: "Lunaura - JavaScript Frameworks",
    image: "/Lunaura.jpg",
  ...
  {
    id: 3,
    title: "Midas Touch - Semester Project 2",
    ...
    <section id="projects" className="min-h-screen flex flex-col items-center justify-center text-white mt-[100px]">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 px-6">
        {projects.map((project) => (
          <div key={project.id} className="bg-custom-dark font-lora rounded-lg shadow-lg p-5 text-center hover:shadow-2xl transition-all duration-300">
            <img 
              src={project.image} 
              alt={project.title} 
            ...
            />
            <h3 className="text-xl font-bold font-lora">{project.title}</h3>
            <button 
              onClick={() => setSelectedProject(project)} 
